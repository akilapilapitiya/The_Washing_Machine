                ...
                {STEPS.map((step, index) => {
                    ...
                    return (
                        ...
                        >
                            {/* Circle */}
                            <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-all duration-300 ${isCompleted
                            ...
                            {/* Label */}
                            <span
                                className={`text-[10px] font-semibold uppercase tracking-wider hidden sm:block ${isActive
                                        ? "text-red-600"
                                        : isCompleted
                                            ? "text-gray-600"
                                            : "text-gray-400"
