...
const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] border border-gray-100 ring-1 ring-black ring-opacity-5 z-50 overflow-hidden transform origin-top-right transition-all animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="flex gap-4">
                    ...
                    {!notification.is_read && (
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 transition-opacity p-1.5 hover:bg-red-100 rounded-full h-fit text-red-600 self-center"
                        title="Mark as read"
                      >
                        <Check size={14} />
                      </button>
