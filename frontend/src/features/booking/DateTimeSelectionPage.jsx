...
const DateTimeSelectionPage = () => {
  ...
  const { vehicleId, serviceIds, locationId, employeeId } = location.state || {}
            ...
            <Card>
              ...
              <CardContent>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedTime === slot.value && 'border-blue-500 bg-blue-500 text-white ring-2 ring-blue-500 ring-offset-0',
                          !available && selectedTime !== slot.value && 'border-gray-200 bg-gray-100 text-gray-400 cursor-not-allowed',
                          available && selectedTime !== slot.value && 'border-gray-300 bg-white hover:border-blue-400 hover:shadow-sm'
                        )}
                      >
                        {slot.display}
                      </button>
                ...
                {availableSlots.length === 0 && (
                  <p className="text-sm text-gray-500 mt-4">No available slots for this date. Please select another date.</p>
                )}
              </CardContent>
            </Card>
          )}
