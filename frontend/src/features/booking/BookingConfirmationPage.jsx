...
import { Calendar, Clock, MapPin, User, Car, Wrench, CheckCircle } from 'lucide-react'
...
const mockLocations = [
  { id: 'main-branch', title: 'The Washing Machine - Main Branch', address: 'Pannipitiya, Colombo, Sri Lanka' },
...
const BookingConfirmationPage = () => {
  ...
  const { vehicleId, serviceIds, locationId, employeeId, date, time } = location.state || {}
  ...
  const formatTime = (timeString) => {
    ...
    return hourNum < 12 ? `${hourNum}:00 AM` : hourNum === 12 ? `12:00 PM` : `${hourNum - 12}:00 PM`
  }
      ...
      <div className="container mx-auto px-4 py-12 space-y-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-semibold">{selectedEmployee?.name || 'Not specified'}</p>
            </CardContent>
          </Card>
