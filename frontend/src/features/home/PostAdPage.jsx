...
const PostAdPage = () => {
  ...
  const validate = () => {
    const newErrors = {};
    if (!formData.title.trim()) newErrors.title = "Business name or ad title is required";
    if (!formData.client_name.trim()) newErrors.client_name = "Contact name is required";
          ...
          <CardContent className="p-12 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 font-medium">
                Our marketing team will review your details and contact you within 24 hours to proceed with your advertisement.
              </p>
            </div>
            <div className="pt-4">
              <Button 
        ...
        <div className="lg:w-1/2 space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-500 font-medium max-w-lg leading-relaxed">
              Showcase your business to our high-traffic customer base. Submit your interest below and join our premium partner network.
            </p>
          </div>

          <div className="space-y-6">
            {[
              { icon: ShieldCheck, title: "Premium Placement", desc: "Top-tier slots on our homepage carousel." },
              { icon: Briefcase, title: "Expert Support", desc: "Our team helps you design the perfect banner." },
              { icon: Megaphone, title: "High Conversion", desc: "Targeted local traffic ready to engage." }
            ].map((feature, i) => (
        ...
        <div className="lg:w-1/2 w-full animate-in fade-in slide-in-from-right-8 duration-700">
          <Card className="border-0 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] rounded-[2.5rem] overflow-hidden bg-white">
            <CardHeader className="p-10 pb-4">
              <CardTitle className="text-2xl font-black tracking-tight text-gray-900">Post Your Ad</CardTitle>
              <CardDescription className="text-gray-500 font-medium pt-1">Provide your details and we'll handle the rest.</CardDescription>
            </CardHeader>
            <CardContent className="p-10 pt-4">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="title" className="text-xs font-black uppercase tracking-widest text-gray-400 flex items-center gap-2">
                    <Megaphone size={12} />
                    Ad/Business Title
                  </Label>
                  ...
                  {errors.title && <p className="text-[10px] text-red-500 font-bold uppercase pl-1">{errors.title}</p>}
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="client_name" className="text-xs font-black uppercase tracking-widest text-gray-400 flex items-center gap-2">
                      <User size={12} />
                      Full Name
                    </Label>
                    <Input
                    ...
                    />
                    {errors.client_name && <p className="text-[10px] text-red-500 font-bold uppercase pl-1">{errors.client_name}</p>}
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="client_contact" className="text-xs font-black uppercase tracking-widest text-gray-400 flex items-center gap-2">
                      <Phone size={12} />
                      Phone Number
                    </Label>
                    <Input
                    ...
                    />
                    {errors.client_contact && <p className="text-[10px] text-red-500 font-bold uppercase pl-1">{errors.client_contact}</p>}
                  </div>
                </div>
