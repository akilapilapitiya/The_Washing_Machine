...
import { Calendar, Clock, MapPin, Car, Wrench, User, ChevronRight } from 'lucide-react'
...
const mockAssignedServices = [
  {
    ...
    vehicle: { brand: 'Toyota', model: 'Corolla', plate: 'ABC-123', nickname: 'Daily', currentMileage: '45,000' },
  ...
  },
  {
    ...
    vehicle: { brand: 'Honda', model: 'Civic', plate: 'XYZ-789', nickname: 'Workhorse', currentMileage: '62,000' },
  ...
  },
  {
    ...
    vehicle: { brand: 'Ford', model: 'F-150', plate: 'TRK-555', nickname: 'Hauler', currentMileage: '28,000' },
  ...
  },
  {
    ...
    vehicle: { brand: 'Nissan', model: 'Altima', plate: 'DEF-456', nickname: null, currentMileage: '35,500' },
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-800">{service.time} • {service.estimatedDuration}</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12 space-y-8">
        <div className="space-y-2">
          <p className="text-sm uppercase tracking-wide text-blue-600 font-semibold">Employee Portal</p>
          <h1 className="text-3xl font-bold">Assigned Services</h1>
          <p className="text-gray-600">View and manage your assigned service appointments.</p>
        </div>

        <Tabs defaultValue="upcoming" className="space-y-6">
          <TabsList>
            <TabsTrigger value="upcoming">Upcoming ({scheduledServices.length})</TabsTrigger>
            <TabsTrigger value="in-progress">In Progress ({inProgressServices.length})</TabsTrigger>
            <TabsTrigger value="completed">Completed ({completedServices.length})</TabsTrigger>
          </TabsList>
            ...
            {inProgressServices.length > 0 ? (
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2">No services in progress</h3>
                  <p className="text-gray-600">Services you're currently working on will appear here.</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
