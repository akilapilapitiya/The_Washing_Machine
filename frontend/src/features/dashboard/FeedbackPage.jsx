...
const mockPreviousFeedbacks = [
  {
    ...
    feedback:
      "Excellent service! The team was very professional and my car looks brand new. Will definitely come back.",
    rating: 5,
  },
  {
    id: "2",
    ...
    feedback:
      "Great attention to detail. The home visit service was very convenient. Minor delay but overall satisfied.",
    rating: 4,
  },
];
...
const FeedbackPage = () => {
  ...
  const handleSubmitFeedback = (e) => {
    ...
    const selectedService = mockCompletedServices.find(
      ...
      <div className="container mx-auto px-4 py-12 space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            Help us improve by sharing your feedback on our services.
          </p>
        </div>
        ...
        <Tabs defaultValue="submit" className="space-y-6">
          <TabsList>
            ...
            <TabsTrigger value="previous">
              Previous Feedback ({submittedFeedbacks.length})
            </TabsTrigger>
          </TabsList>
                  ...
                  <Card key={feedback.id}>
                    <CardHeader>
                      <div className="space-y-2">
                        <CardTitle className="text-lg">
                          {feedback.service.vehicle.nickname ||
                            `${feedback.service.vehicle.brand} ${feedback.service.vehicle.model}`}
                        </CardTitle>
                        <p className="text-sm text-gray-600">
                          {feedback.service.vehicle.plate}
                        </p>
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              Service:{" "}
                              {formatDate(feedback.service.serviceDate)}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600">
                          {feedback.service.services.join(", ")}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-700">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        <span className="text-xs text-gray-500">
                          Submitted on {formatDate(feedback.date)}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
