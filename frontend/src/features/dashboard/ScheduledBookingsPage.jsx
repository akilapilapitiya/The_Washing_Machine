...
import { Calendar, Clock, MapPin, Car, Wrench, User, CheckCircle, XCircle } from 'lucide-react'
...
const mockBookings = [
  {
    id: '1',
    status: 'pending',
    vehicle: { make: 'Toyota', model: 'Corolla', plate: 'ABC-123', nickname: 'Daily' },
  ...
  },
  {
    id: '2',
    status: 'confirmed',
    vehicle: { make: 'Honda', model: 'Civic', plate: 'XYZ-789', nickname: 'Workhorse' },
  ...
  },
  {
    id: '3',
    status: 'completed',
    vehicle: { make: 'Ford', model: 'F-150', plate: 'TRK-555', nickname: 'Hauler' },
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-2 text-sm">
            ...
            <span className="text-gray-800">{new Date(booking.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
          </div>
          <div className="flex items-start gap-2 text-sm">
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12 space-y-8">
        ...
        <Tabs defaultValue="upcoming" className="space-y-6">
          <TabsList>
            <TabsTrigger value="upcoming">Upcoming ({pendingBookings.length})</TabsTrigger>
