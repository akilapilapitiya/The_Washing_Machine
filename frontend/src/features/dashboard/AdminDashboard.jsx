  ...
  <Link to={to} className="group block">
    <div className="flex items-center p-4 rounded-xl border border-gray-100 bg-white hover:border-red-200 hover:shadow-md transition-all">
      ...
      <div className="ml-4 flex-1">
        <h4 className="font-bold text-gray-900 leading-tight group-hover:text-red-700 transition-colors">
          {title}
        </h4>
                  ...
                  {pendingBookings > 0 ? (
                    <>
                      ...
                      <Button
                        asChild
                        size="sm"
                        className="mt-4 bg-red-600 hover:bg-red-700 text-white font-bold w-full"
                      >
