...
const QuickAction = ({ title, description, to, icon: Icon, primary }) => (
  <Link to={to} className="group">
    <Card
      className={`h-full border-gray-200 transition-all hover:border-red-300 hover:shadow-lg ${primary ? "bg-white border-red-200 ring-1 ring-red-50" : "bg-white"}`}
    >
      <CardHeader className="pb-3">
        <div className="flex items-center space-x-3">
          <div
            className={`p-2.5 rounded-lg ${primary ? "bg-red-600 text-white shadow-sm" : "bg-red-50 text-red-600"} transition-colors group-hover:scale-105 duration-300`}
          >
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-red-100 max-w-lg leading-relaxed">
              Keep your fleet shining. Book your next premium service today and
          ...
          <Button
            asChild
            size="lg"
            className="bg-white text-red-700 hover:bg-gray-50 font-bold shadow-sm shrink-0 h-12 px-8 rounded-xl"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <MetricCard
          ...
          value={
            upcomingBooking ? formatDateSL(upcomingBooking.bookingdate) : "-"
          }
          icon={Clock}
          description={
            upcomingBooking
              ...
              <div className="flex flex-col sm:flex-row items-center p-6 gap-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Your last completed service was on{" "}
                    <span className="font-semibold text-gray-800">
                      {formatDateSL(lastCompleted.bookingdate)}
                    </span>
                ...
                <Button
                  asChild
                  className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg shadow-sm h-11 px-6"
                >
                  <Link to="/dashboard/book">
                    Rebook Now
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-3">
                      <span
                        className={`text-xs font-bold uppercase tracking-wider px-2.5 py-1 rounded-full ${recentActivity[0].bookingstatus === "completed" ? "bg-green-50 text-green-700" : recentActivity[0].bookingstatus === "confirmed" ? "bg-blue-50 text-blue-700" : recentActivity[0].bookingstatus === "pending" ? "bg-yellow-50 text-yellow-700" : "bg-gray-100 text-gray-600"}`}
                      >
                        {recentActivity[0].bookingstatus}
                      </span>
                      <span className="text-xs text-gray-400 font-bold">
                        #{recentActivity[0].bookingid}
                      </span>
                    </div>
                    <p className="font-bold text-gray-900 text-lg mb-2">
                      {recentActivity[0].servicename || "Wash Service"}
                    </p>
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200 font-semibold h-11"
                  >
