...
const ProfilePage = () => {
  ...
  const fetchDependentsAndVehicles = async () => {
    if (
      ...
      try {
        const data = await dependentService.getMyDependents();
        setDependents(data || []);
      } catch (error) {
  ...
  const handleAddDependent = async (e) => {
    ...
    if (
      ...
      !newDependent.contact_number
    ) {
      toast.error("Please fill in all required fields");
      return;
    }
    if (!/^[0-9]{10}$/.test(newDependent.contact_number)) {
    ...
    try {
      await dependentService.addDependent(newDependent);
      ...
      toast.error(error.response?.data?.error || "Failed to add dependent");
    } finally {
    ...
    <div className="space-y-8 py-4">
      <div className="grid gap-8 md:grid-cols-12 items-start">
        ...
        <div className="md:col-span-8 space-y-8">
              ...
              {!isEditing ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="flex justify-end gap-3 pt-6 border-t border-gray-50">
                    ...
                    <Button
                      type="submit"
                      className="bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold h-11 px-10 transition-all"
                      disabled={isLoading}
                    >
                      {isLoading ? (
          ...
          {/* Dependents & Emergency Contacts Section */}
          {(userType === "employee" ||
            userType === "cashier" ||
            userType === "owner" ||
            userType === "manager") && (
                ...
                <div className="grid md:grid-cols-12">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                      ...
                      <Button
                        type="submit"
                        className="bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold px-8 h-11 transition-all flex items-center gap-2 group"
