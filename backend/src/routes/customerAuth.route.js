...
customerAuthRouter.post("/signup", validateSchema(customerValidator.createCustomer), customerSignUp);
customerAuthRouter.post("/signin", validateSchema(customerValidator.loginCustomer), customerSignIn);
